...
func TestInitLedger(t *testing.T) {
	...
	err := assetTransfer.InitLedger(transactionContext, time.Now().String())
...
func TestReadAsset(t *testing.T) {
	...
	expectedAsset := &chaincode.Service{ServiceID: "asset1"}
...
func TestUpdateAsset(t *testing.T) {
	...
	chaincodeStub.GetStateReturns(bytes, nil)
	assetTransfer := chaincode.SmartContract{}
	err = assetTransfer.UpdateAsset(transactionContext, "", "", "", time.Now())
	require.NoError(t, err)

	chaincodeStub.GetStateReturns(nil, nil)
	err = assetTransfer.UpdateAsset(transactionContext, "asset1", "", "", time.Now())
	require.EqualError(t, err, "the asset asset1 does not exist")
...
func TestDeleteAsset(t *testing.T) {
	...
	asset := &chaincode.Service{ServiceID: "asset1"}
...
func TestGetAllAssets(t *testing.T) {
	...
	require.NoError(t, err)
	require.Equal(t, []*chaincode.Service{asset}, assets)
